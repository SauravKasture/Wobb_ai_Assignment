...
public class UtilityClass
{
		...
		{
			FileInputStream file= new FileInputStream("D:\\eclipse\\Wobb_ai\\TestData\\Assignment.xlsx");
		...
		{
			FileInputStream file=new  FileInputStream("D:\\eclipse\\Wobb_ai_\\Wobb_Ai.properties");
		...
		public static void getScrenshot(WebDriver driver,int TestCaseId) throws IOException
		{
			...
			File des= new File("D:\\eclipse\\Wobb_ai\\Screenshot\\TestCaseId"+TestCaseId+".png");
